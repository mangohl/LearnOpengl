...
int transformProcess()
{
	...
	glfwSetFramebufferSizeCallback(window, transform::framebuffer_size_callback);
...
// ---------------------------------------------------------------------------------------------------------
void transform:: processInput(GLFWwindow *window)
{
...
// ---------------------------------------------------------------------------------------------
void transform:: framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
