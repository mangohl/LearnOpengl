...
int colorTriangleProcess()
{
	...
	// ------------------------------------
	Shader ourShader("../OpenglExercise/corlorTriangle.vs", "../OpenglExercise/corlorTriangle.fs"); // you can name your shader files however you like
...
// ---------------------------------------------------------------------------------------------------------
void colorTriangle:: processInput(GLFWwindow *window)
{
...
// ---------------------------------------------------------------------------------------------
void colorTriangle:: framebuffer_size_callback(GLFWwindow* window, int width, int height)
{
